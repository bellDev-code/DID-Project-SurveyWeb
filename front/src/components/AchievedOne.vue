            ...
            <div class="row">
                <div class="col-xl-6 col-lg-12">
                    <div class="achieved_one_left_img">
                        <img
                            src="/assets/images/resources/achieved_1-img-1.jpg"
                            alt="Achieved One Image"
                        />
                    </div>
                </div>
                <div class="col-xl-6 col-lg-12">
                    <div class="achieved_one_right-content">
                        <div class="achieved_one_right_img">
                            <img
                                src="/assets/images/resources/achieved_1-img-2.jpg"
                                alt="Achieved Two Image"
                            />
                        </div>
                        ...
                        <div class="achieved_one_text">
                            <p>
                                ...
                                some form by inject humour or donec vel erat
                                sollicitudin, dapibus dui at, porttitor sem.
                            </p>
                        </div>
                        <div class="achieved_one_btn">
                            <router-link to="/why_choose_us" class="thm-btn"
