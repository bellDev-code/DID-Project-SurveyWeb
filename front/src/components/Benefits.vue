<template>
    <section class="benefits">
        <div
            class="benefits_bg"
            style="
                background-image: url(/assets/images/resources/benifits_bg.png);
            "
        ></div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="my-auto">
                        <div class="benefits_text">
                            <p>
                                ...
                                alteration in some form, by injected humou or
                                randomised words which don't look even slightly
                                believable. There are many variations of
                                passages of available but the majority have
                                suffered alteration in some form, by injected
                                humou or randomised words which don't look even
                                slightly believable.
                            </p>
                        </div>
                    </div>
            ...
            <div class="benefits_bottom_part">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div
                            class="benefits_single wow fadeInUp"
