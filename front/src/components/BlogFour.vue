        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div
                        class="blog_four_single wow fadeInLeft"
                        data-wow-delay="300ms"
                    >
                        <div class="blog_four_image">
                            <img
                                src="/assets/images/blog/blog-4-img-1.jpg"
                                alt=""
                            />
                        ...
                        <div class="blog-four_content">
                            ...
                            <h3>
                                <router-link
                                    to="/news_detail"
                                    class="blog_four_title"
                                    >Agriculture Miracle you<br />Don't Know
                                    About</router-link
                                >
                            </h3>
                ...
                <div class="col-xl-4 col-lg-4">
                    ...
                    >
                        <div class="blog_four_image">
                            <img
                                src="/assets/images/blog/blog-4-img-2.jpg"
                                alt=""
                            />
                            <div class="blog_four_date_box">
                                <p>30 Oct, 2019</p>
                        ...
                        <div class="blog-four_content">
                            ...
                            <h3>
                                <router-link
                                    to="/news_detail"
                                    class="blog_four_title"
                                    >Winter Wheat Harvest Gathering<br />Momentum</router-link
                                >
                            </h3>
                            <div class="blog_four_read_more_btn">
                                <router-link to="/news_detail"
