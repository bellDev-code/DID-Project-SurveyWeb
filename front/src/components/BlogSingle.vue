                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="news_detail_left">
                        <div class="news_detail_image_box">
                            <img
                                src="/assets/images/blog/news-detail-img-1.jpg"
                                alt=""
                            />
                        ...
                        <div class="author-one">
                            <div class="author-one__image">
                                <img
                                    src="/assets/images/blog/author-1-1.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="author-one__content">
                                ...
                                <p>
                                    ...
                                    remaining unchanged. It was popularised in
                        ...
                        <div class="comment-one">
                            ...
                            <div class="comment-one__single">
                                <div class="comment-one__image">
                                    <img
                                        src="/assets/images/blog/comment-1-1.png"
                                        alt=""
                                    />
                                </div>
                                <div class="comment-one__content">
                                    ...
                                    <p>
                                        ...
                                        typesetting unchanged. It was
                                        popularised in the sheets containing
                                        lorem ipsum is simply free text
                                        available in the martket to use now.
                                    </p>
                                    <a href="#" class="thm-btn comment-one__btn"
                                        >Reply</a
                                    >
                                </div>
                            </div>
                            <div class="comment-one__single">
                                <div class="comment-one__image">
                                    <img
                                        src="/assets/images/blog/comment-1-2.png"
                                        alt=""
                                    />
                                </div>
                                <div class="comment-one__content">
                                ...
                                <li>
                                    ...
                                    <div class="sidebar__post-content">
                                        <h3>
                                            ...
                                            >
                                            <router-link to="/news_detail"
                                                >Agriculture Miracle you Don't
                                                Know About</router-link
                                            >
                                        </h3>
                                    </div>
                                </li>
