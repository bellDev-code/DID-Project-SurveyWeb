            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4">
                    <div class="recent_project_single mrb-30">
                        <div class="project_img_box">
                            <img
                                src="/assets/images/project/recent-pro-img-1.jpg"
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="recent_project_single mrb-30">
                        <div class="project_img_box">
                            <img
                                src="/assets/images/project/recent-pro-img-2.jpg"
                                alt="Recent Project Img"
                            />
                            <div class="project_content">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="recent_project_single mrb-30">
                        <div class="project_img_box">
                            <img
                                src="/assets/images/project/recent-pro-img-3.jpg"
                                alt="Recent Project Img"
                            />
                            <div class="project_content">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="recent_project_single mrb-30">
                        <div class="project_img_box">
                            <img
                                src="/assets/images/project/recent-pro-img-4.jpg"
                                alt="Recent Project Img"
                            />
                            <div class="project_content">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="recent_project_single mrb-30">
                        <div class="project_img_box">
                            <img
                                src="/assets/images/project/recent-pro-img-5.jpg"
                                alt="Recent Project Img"
                            />
                            <div class="project_content">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="recent_project_single mrb-30">
                        <div class="project_img_box">
                            <img
                                src="/assets/images/project/recent-pro-img-6.jpg"
                                alt="Recent Project Img"
                            />
                            <div class="project_content">
